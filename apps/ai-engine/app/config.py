...
class Settings(BaseSettings):
    ...
    THREAT_MODEL_PATH: str = Field(
        default="./models/threat_classifier_v1.pkl",
        description="Path to the threat classification model"
    )
    ...
    REDIS_URL: str = Field(
        ...
        description="Redis connection URL for caching scan results"
    )
    CACHE_TTL: int = Field(
    ...
    VIRUSTOTAL_API_KEY: Optional[str] = Field(
        default=None,
        description="VirusTotal API key for additional APK analysis"
    )
